...
git remote add publisher https://bhardwaj96:github_password@github.com/bhardwaj96/helm-library.git
# git remote add publisher https://bhardwaj96:github_password@github.com/helm-library.git
# git remote add publisher https://github_password@github.com/bhardwaj96/helm-library.git
# git remote add publisher https://bhardwaj96:{Dhakkan96}@github.com/bhardwaj96/helm-library.git
